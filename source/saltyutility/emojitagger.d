...
string tag(string dish)
{
    ...
    mixin(Rule!("spargel", FoodAndDrink.eggplant));
    ...
    mixin(Rule!("abanossi", FoodAndDrink.hotDog)); // Cabanossi, Kabanossi
    ...
    mixin(Rule!("holland", Flags.flagNetherlands)); // Sauce Hollandaise
